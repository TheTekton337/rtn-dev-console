...
@property (nonatomic, copy) RCTBubblingEventBlock onTransferStart;
@property (nonatomic, copy) RCTBubblingEventBlock onTransferProgress;
@property (nonatomic, copy) RCTBubblingEventBlock onTransferEnd;
